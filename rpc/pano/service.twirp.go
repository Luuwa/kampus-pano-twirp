...
// NewPanoProtobufClient creates a Protobuf client that implements the Pano interface.
// It communicates using Protobuf and can be configured with a custom HTTPClient.
func NewPanoProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Pano {
...
func (c *panoProtobufClient) GetPost(ctx context.Context, in *GetPostRequest) (*Post, error) {
	...
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *GetPostRequest) (*Post, error) {
...
func (c *panoProtobufClient) callGetPost(ctx context.Context, in *GetPostRequest) (*Post, error) {
	out := new(Post)
...
// NewPanoJSONClient creates a JSON client that implements the Pano interface.
// It communicates using JSON and can be configured with a custom HTTPClient.
func NewPanoJSONClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Pano {
	if c, ok := client.(*http.Client); ok {
		client = withoutRedirects(c)
	}
...
func (c *panoJSONClient) GetPost(ctx context.Context, in *GetPostRequest) (*Post, error) {
	ctx = ctxsetters.WithPackageName(ctx, "kampus.pano")
	ctx = ctxsetters.WithServiceName(ctx, "Pano")
	ctx = ctxsetters.WithMethodName(ctx, "GetPost")
	caller := c.callGetPost
...
// NewPanoServer builds a TwirpServer that can be used as an http.Handler to handle
// HTTP requests that are routed to the right method in the provided svc implementation.
// The opts are twirp.ServerOption modifiers, for example twirp.WithServerHooks(hooks).
func NewPanoServer(svc Pano, opts ...interface{}) TwirpServer {
...
func (s *panoServer) writeError(ctx context.Context, resp http.ResponseWriter, err error) {
	writeError(ctx, resp, err, s.hooks)
}

// handleRequestBodyError is used to handle error when the twirp server cannot read request
func (s *panoServer) handleRequestBodyError(ctx context.Context, resp http.ResponseWriter, msg string, err error) {
...
// PanoPathPrefix is a convenience constant that may identify URL paths.
// Should be used with caution, it only matches routes generated by Twirp Go clients,
// with the default "/twirp" prefix and default CamelCase service and method names.
// More info: https://twitchtv.github.io/twirp/docs/routing.html
const PanoPathPrefix = "/twirp/kampus.pano.Pano/"

func (s *panoServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	ctx := req.Context()
	ctx = ctxsetters.WithPackageName(ctx, "kampus.pano")
	ctx = ctxsetters.WithServiceName(ctx, "Pano")
	...
	if pkgService != "kampus.pano.Pano" {
...
func (s *panoServer) serveGetPost(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
...
func (s *panoServer) serveGetPostJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetPost")
	...
	handler := s.Pano.GetPost
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *GetPostRequest) (*Post, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Pano.GetPost(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Post)
...
func (s *panoServer) serveGetPostProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "GetPost")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *panoServer) ServiceDescriptor() ([]byte, int) {
	return twirpFileDescriptor0, 0
}

func (s *panoServer) ProtocGenTwirpVersion() string {
	return "v8.1.3"
}
...
func (s *panoServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "kampus.pano", "Pano")
}
